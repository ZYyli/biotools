...
run_trans_enrichment <- function(
  ...
  sim_results <- bplapply(1:n_simulations, FUN = function(i) {
    ...
    sense_hits_p <- findOverlaps(random_gr, trans_p_gr, type = "any")
    sense_hits_m <- findOverlaps(random_gr, trans_m_gr, type = "any")
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjk4NjY4NjQsMjEzNjU2ODQ3Myw4NzYyOT
E4NzYsNjQ5NzkxNTQ5LDkzMDU3MjEwNSwtMTA0NzU4MTk3NSwt
MTk4MDczNDQ5OSwtMTQxNDM0NzAwNiwtODgxMDQwNDQxLDE2NT
QyNzU0NjldfQ==
-->