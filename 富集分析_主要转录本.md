...
run_trans_enrichment <- function(
  ...
  sim_results <- bplapply(1:n_simulations, FUN = function(i) {
    ...
    sense_hits_p <- findOverlaps(random_gr, trans_p_gr, type = "any", ignore.strand = FALSE)
    sense_hits_m <- findOverlaps(random_gr, trans_m_gr, type = "any", ignore.strand = FALSE)
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc5NzY3NjMyNSwtNjMxNDk3MTc1LC0zND
E3MzA1OTQsMTkzNjc3Njc3LDIxMzY1Njg0NzMsODc2MjkxODc2
LDY0OTc5MTU0OSw5MzA1NzIxMDUsLTEwNDc1ODE5NzUsLTE5OD
A3MzQ0OTksLTE0MTQzNDcwMDYsLTg4MTA0MDQ0MSwxNjU0Mjc1
NDY5XX0=
-->