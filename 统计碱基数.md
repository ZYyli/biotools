...
cat 5utr_merged.bed cds_merged.bed 3utr_merged.bed | bedtools sort -i - | bedtools merge -i - | awk '{sum += $3 - $2} END {print "5UTR+CDS+3UTR合并后总长度:", sum}'
```
### 结果
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxMzcwNTgzMSwtMTA5NzcxNDQyOCwxNz
czNjIzNTM4LC00NTQ2MzUsMTU4MjYzOTkxMCwxMDYwMTA4MzE1
LDE4OTk5MTc1NDMsMTU0NzIwODI5NSwxMzg1ODYzMTU1LDE4MT
M4OTg3ODVdfQ==
-->