...
new.cluster.ids <- c('T_cell','T_cell','Macrophage','Hepatocytes','NK_cell',
                     'Macrophage','dendritic cell','dendritic cell','Hepatocytes',
                     'T_cell','Endothelial cell','MSC','B_cell','Hepatocytes',
                     'B_cell','Endothelial cell','Hepatocytes','Cycling cell',
                     'T_cell','BM & Prog','Epithelial cell','Macrophage',
                     'T_cell','Macrophage','pDC','B_cell','Macrophage',
                     'Hepatocytes','T_cell','Fibroblast')
names(new.cluster.ids) <- levels(qcctrl)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc0OTgzMTI0LDE4Njg3NjU3OTIsLTQ5Mj
A2MjQ1MywxNTU4MjA4ODc1LC0xNTIxODU0NzAxLC0xNDkwNDEw
MzIxLDEzOTA3ODQ0ODAsLTEwNjk2MTY4Miw3MTM5NzM0ODYsOD
Q4MzczMjgyLC05ODYzMzI5NDMsNDExMTkxNDExLC03NjUyMjYz
OTEsMTA0ODQ0ODU4NCwyMDQzODA4MzI1LDE2MjIzMjI2ODIsLT
IwNDQ2NTMxMzcsMTM4MjA2MjMyNCwxNjQxOTU2NTA1LDgzOTg0
MDcyNF19
-->