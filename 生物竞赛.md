...
p6 = plotc <- p1+p2+ plot_layout(guides = 'collect')
#保存三张图
ggsave("tSNE_celltype.pdf", p2, width=8,height=8)
ggsave("cell_identify/UMAP_celltype.pdf", p4, width=8,height=8)
ggsave("cell_identify/celltype.pdf", p5, width=16,height=8)
ggsave("cell_identify/celltype.png", p5, width=16,height=8)
##对比tsne图与umap图
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2MDYwMzg5NiwtMTQ5MDQxMDMyMSwxMz
kwNzg0NDgwLC0xMDY5NjE2ODIsNzEzOTczNDg2LDg0ODM3MzI4
MiwtOTg2MzMyOTQzLDQxMTE5MTQxMSwtNzY1MjI2MzkxLDEwND
g0NDg1ODQsMjA0MzgwODMyNSwxNjIyMzIyNjgyLC0yMDQ0NjUz
MTM3LDEzODIwNjIzMjQsMTY0MTk1NjUwNSw4Mzk4NDA3MjQsMT
QyNTQwNzA0MiwtOTE4NTczOTM5LDIwMTQ4NTQxMTgsNTI3NTIw
NDQwXX0=
-->