...
#vlnplot展示
p1 <- Vlnplot(qcctrl,features=select_genes,pt.size=0,group.by="celltype",ncol=7)
ggsave("selectgenes_VlnPlot.png", p1, width=30 ,height=8)
#featureplot展示
p2 <- FeaturePlot(qcctrl,features=select_genes, reduction ="tsne",label=T,ncol=2)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzEzOTczNDg2LDg0ODM3MzI4MiwtOTg2Mz
MyOTQzLDQxMTE5MTQxMSwtNzY1MjI2MzkxLDEwNDg0NDg1ODQs
MjA0MzgwODMyNSwxNjIyMzIyNjgyLC0yMDQ0NjUzMTM3LDEzOD
IwNjIzMjQsMTY0MTk1NjUwNSw4Mzk4NDA3MjQsMTQyNTQwNzA0
MiwtOTE4NTczOTM5LDIwMTQ4NTQxMTgsNTI3NTIwNDQwLC0xMD
UwNDEwMTM3LC0xMDEzMTQ5Nzg2LC0xMjM1MTAwMzQzLC0xOTQ5
NTc5NTQzXX0=
-->