...
plot = DoHeatmap(qcctrl, features = top10_genes, group.by = "seurat_clusters",group.bar = T,size = 4)
#保存热图
ggsave("top10_markers.pdf", plot=plot, width=8, height=6)
ggsave("top10_markers.png", plot=plot1, width=8, height=6)
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODA1Njg3MDEsMTUxMTkyMzkyNSwtMT
UzOTg3NzI1LC0xOTg2NjM5MzE4LC0yMTI1OTI4MDMxLC0xNjYy
NDA0NTEyLC0yMjk2NzU4MzgsMTAwNjc0MzY2OCwtNzEzMjM2MD
AxLC00OTQ4Mjc0NTIsNjc5ODg2MjIyLC0xNTAyNTI0MDc0LDUy
NzE0NDgxNCw2MDQyMTcwMjldfQ==
-->